...
Unfortunately I heard online that the creator who made lvllvl, James, passed away.
His github here: https://github.com/jaammees/lvllvl 
His itch.io here: https://jaammees.itch.io/lvllvl 
...
For this desktop app version, you can save and delete a file. Although open local file doesn’t work and share project also doesn’t work. Installing the app installs two versions of the same program for some reason (called lvllvl and My Program) but you can delete the second one. There are other features that also may not work.
...
I switched over to using nw.js and the nw.js with Apache PHP mod.
Nw.js found here: https://nwjs.io/ 
Mod found here: https://github.com/Tommy0412/NW.js-with-Apache-PHP 

For those who download the github page into a zip file, it has to be nested as lvllvl_app/lvllvl/src/(everything on github page) for it to work.
...
Download here: https://github.com/flowerdev88/lvllvl-desktop-app-work-in-progress-/releases/tag/v1.2.0 
